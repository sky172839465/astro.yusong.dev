...
[範例網站](https://pwa-sharing.pages.dev/) 可以參考實際上在不同裝置上會如何呈現，範例網站的程式碼解說參考 [這篇](/blog/pwa-example/) 文章。
...
- short_name
  ...
  <table data-center>
    ...
    <tr>
      <td>
        <img src="/blog/web-app-manifest/macOS-app.jpg" alt="macOS 安裝 Web App 顯示名稱" />
      </td>
      <td>
        <img src="/blog/web-app-manifest/iOS-app.jpg" alt="iOS 安裝 Web App 顯示名稱" />
      </td>
    </tr>
  </table>
- description
  ...
  <div>
    <img src="/blog/web-app-manifest/rich-install-macOS.png" alt="macOS 安裝 Web App 描述" />
  </div>
- scope
...
- display
  ...
  <table data-center>
    <tr>
      <td>standalone</td>
      <td>
        <img src="/blog/web-app-manifest/display-standalone.jpg" alt="macOS standalone 模式" />
      </td>
    </tr>
    <tr>
      <td>minimal-ui</td>
      <td>
        <img src="/blog/web-app-manifest/display-minimal-ui.jpg" alt="macOS minimal-ui 模式" />
      </td>
    </tr>
  </table>
- background_color
...
- theme_color
  ...
  <table data-center>
    <tr>
      <td>macOS light</td>
      <td>
        <img src="/blog/web-app-manifest/macOS-header-light-mode.jpg" alt="macOS light 模式外觀" />
      </td>
    </tr>
    <tr>
      <td>macOS dark</td>
      <td>
        <img src="/blog/web-app-manifest/macOS-header-dark-mode.jpg" alt="macOS dark 模式外觀" />
      </td>
    </tr>
    <tr>
      <td>iOS light</td>
      <td>
        <img src="/blog/web-app-manifest/iOS-header-light-mode.jpg" alt="iOS light 模式外觀" />
      </td>
    </tr>
    <tr>
      <td>iOS dark</td>
      <td>
        <img src="/blog/web-app-manifest/iOS-header-dark-mode.jpg" alt="iOS dark 模式外觀" />
      </td>
    </tr>
  </table>
...
<table data-center>
  ...
  <tr>
    ...
    <td>
      <img src="/blog/web-app-manifest/win10-app.jpg" alt="Windows10 安裝 Web App 顯示名稱" />
    </td>
    <td>
      <img src="/blog/web-app-manifest/iOS-app.jpg" alt="iOS 安裝 Web App 顯示名稱" />
    </td>
    <td>
      <img src="/blog/web-app-manifest/andriod15-app.jpg" alt="Android 安裝 Web App 顯示名稱" />
    </td>
  </tr>
</table>
...
<div>
  <img src="/blog/web-app-manifest/macOS-rich-install.jpg" alt="macOS PWA Web app 桌面版安裝畫面" />
</div>
...
<table data-center>
  ...
  <tr>
    <td>
      <img src="/blog/web-app-manifest/macOS-mock-rich-install.jpg" alt="macOS 自訂安裝界面" />
    </td>
    <td>
      <img src="/blog/web-app-manifest/iOS-mock-rich-install.jpg" alt="iOS 自訂安裝界面" />
    </td>
    <td>
      <img src="/blog/web-app-manifest/andriod-mock-rich-install.jpg" alt="Andriod 自訂安裝界面" />
    </td>
  </tr>
</table>
